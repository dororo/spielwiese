Capitan.Component.instagram = function ($) {
  ...
  */
  _.bindEvents = function () {
    ...
    Capitan.Vars.$doc.on('click', o.selectors.trigger, function (e) {
      e.preventDefault();
      //_.callInstaApi();
  ...
  **/
  _.initPlugin = function () {
                ...
                '<div class="teaser">' +
                	...
                	'<div class="teaser__content">' +
                		'<div class="teaser__text">' +
                			'{{caption}}' +
                      '<a class="text-link" href="{{link}}" target="_blank" alt="{{model.user.username}}">click here</a>' +
                		'</div>' +
                	'</div>' +
                '</div>' +
              '</div>';
    ...
    feed = new Instafeed({
      ...
      after: function() {
        if (!this.hasNext()) {
          $(o.selectors.trigger).attr("disabled", true);
        }
      }
    });
